...
export const workoutPlanRoutes = async (app: FastifyInstance) => {
	app.withTypeProvider<ZodTypeProvider>().route({
		...
		url: "/",
		schema: {
			operationId: "list-workout-plans",
			tags: ["Workout Plan"],
	...
	app.withTypeProvider<ZodTypeProvider>().route({
		...
		schema: {
			operationId: "start-workout-session",
			tags: ["Workout Plan"],
	...
	app.withTypeProvider<ZodTypeProvider>().route({
		...
		schema: {
			operationId: "update-workout-session",
			tags: ["Workout Plan"],
